...
# define SERVER     "169.254.125.211"

# define MULTIUSERS   1
# define DEBUG        1                  // user debug = 1;
# define BUFLEN       512                // Max length of buffer
# define PORT         "27015"            // Port Name
# define ___stagger   "FIFO"             // (First in, first out)

const char FOLDERTABLES[100] = "D:\\PROJETOS\\SGBD\\Entities\\";
